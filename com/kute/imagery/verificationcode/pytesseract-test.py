...
tesseract_cmd = 'D:\\softers\\Tesseract-OCR\\tesseract'
...
def get_errors(error_string):
    ...
    error_lines = tuple(line for line in lines if str(line).find('Error') >= 0)
...
def main():
    # if len(sys.argv) == 2:
        # filename = sys.argv[1]
    filename = 'E:\\pythonwork\\purepythontest\\com\\kute\\imagery\\verificationcode\\gpin.png'
    try:
